    ...
    <div className="d-none d-lg-block">
      <div className="input-group form-row">
        ...
        <div className="input-group-append">
          <button className="btn btn-outline-success" type="button" onClick={onSave}>Add flashcard</button>
        </div>
      </div>
    </div>
    <div className="d-lg-none">
      <input type="text" className="form-control" id="question" name="question" placeholder="Question" onChange={onChange}/>
      <input type="text" className="form-control" id="answer" name="answer" placeholder="Answer" onChange={onChange}/>
      <div className="row">
        <div className="col-md-6 offset-md-6">
          <button className="btn btn-outline-success btn-block" type="button" onClick={onSave}>Add flashcard</button>
        </div>
      </div>
    </div>
  </div>
